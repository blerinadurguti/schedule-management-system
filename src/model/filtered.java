...
public class filtered {
	...
	public static filtered fromResultSet(ResultSet res) {
		...
		String kohaFillimit = res.getString("KohaFillimit");
		 	return new filtered(id,drejtimi,l_u,lenda,profesori,viti,grupi,salla,dita,kohaFillimit);
	...
	public static filtered createOraret(int id,String drejtimi, String l_u, String lenda, String profesori, String viti, String grupi, String salla, String dita, String kohaFillimit) {
		return new filtered(id,drejtimi,l_u,lenda,profesori,viti,grupi,salla,dita,kohaFillimit);
	}
	
	public filtered(int id,String drejtimi, String l_u, String lenda, String profesori,String viti,String grupi, String salla, String dita, String kohaFillimit) {
		this.id = id;
