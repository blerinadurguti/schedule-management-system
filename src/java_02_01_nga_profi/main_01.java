...
//		MyRectangle rect = new MyRectangle();
		MyRectangleAdvanced rect = new MyRectangleAdvanced();
		rect.setWidth(200);
		rect.setHeight(200);
		
		MyFan fan = new MyFan();
		fan.setWidth(100);
		fan.setNumberOfArcs(5);
		...
		Pane pane = new Pane();
		pane.getChildren().addAll(rect1,rect,fan);
...
class MyFan extends Pane {
	...
	private void draw() {
		double x,y,radius;
		x = 200 + super.getWidth() / 2;
		y = 200 + super.getHeight() / 2;
